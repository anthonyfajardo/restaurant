...
if ( ! function_exists( 'restaurant_theme_setup' ) ) :
	...
	function restaurant_theme_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'restaurant-theme' ),
		) );
 ...
 */
function restaurant_theme_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'restaurant_theme_content_width', 640 );
}
add_action( 'after_setup_theme', 'restaurant_theme_content_width', 0 );
...
function restaurant_theme_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'restaurant-theme' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'restaurant-theme' ),
...
function restaurant_theme_scripts() {
	...
	wp_enqueue_script( 'restaurant-theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'restaurant-theme-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
